...
const SpriteOutlineIcons = (props: Props): React.ReactElement => {
...
SpriteOutlineIcons.renderIcon = (icon: string): React.ReactElement => (
   <div className='flex gap-2 px-2 mb-[4px]' key={icon}>
...
export default observer(SpriteOutlineIcons)
