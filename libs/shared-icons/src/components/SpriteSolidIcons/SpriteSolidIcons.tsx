...
const SpriteSolidIcons = (props: Props): React.ReactElement => {
...
SpriteSolidIcons.renderIcon = (icon: string): React.ReactElement => (
   <div className='flex gap-2 px-2 mb-[4px]' key={icon}>
      <div>
         <Icon
            type='SOLID'
...
export default observer(SpriteSolidIcons)
